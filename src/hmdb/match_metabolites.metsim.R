...
write.table(fuz_check, 'results/hmdb_match/metsim/fuzzy_match_check.txt', sep = '\t', col.names = T, row.names = F, quote = F)

# Read in the metabolites to keep/add to `res`
fuz_keep = read.table('results/hmdb_match/metsim/fuzzy_match_keep.txt', sep = '\t', header = T, stringsAsFactors = F, quote = '')
...
write.table(check, 'results/hmdb_match/metsim/lipid_multi_check.txt', sep = '\t', col.names = T, row.names = F, quote = F)

# Read in the metabolites to keep:
keep = read.table('results/hmdb_match/metsim/lipid_multi_keep.txt', sep = '\t', header = T, stringsAsFactors = F, quote = '')
