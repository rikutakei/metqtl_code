...
all_met_coding = read.table('results/pathway/david_141_met_genes.prot_only.txt', sep = '\t', header = T, stringsAsFactors = F, quote = '')

# plasma_only = read.table('results/pathway/david_plasma_only_genes.txt', sep = '\t', header = T, stringsAsFactors = F)
plasma_only_coding = read.table('results/pathway/david_plasma_only_genes.prot_only.txt', sep = '\t', header = T, stringsAsFactors = F, quote = '')

# plasma_urine = read.table('results/pathway/david_plasma_urine_genes.txt', sep = '\t', header = T, stringsAsFactors = F)
plasma_urine_coding = read.table('results/pathway/david_plasma_urine_genes.prot_only.txt', sep = '\t', header = T, stringsAsFactors = F)
...
dim(all_met_coding_sig)
dim(plasma_only_coding_sig)
dim(plasma_urine_coding_sig)
dim(hmdb_sig)

# write.table(all_met, 'results/pathway/david_144met_genes.clean.txt', sep = '\t', col.names = T, row.names = F, quote = F)
write.table(all_met_coding, 'results/pathway/david_141met_genes.prot_only.clean.txt', sep = '\t', col.names = T, row.names = F, quote = F)
# write.table(plasma_only, 'results/pathway/david_plasma_only_genes.clean.txt', sep = '\t', col.names = T, row.names = F, quote = F)
write.table(plasma_only_coding, 'results/pathway/david_plasma_only_genes.prot_only.clean.txt', sep = '\t', col.names = T, row.names = F, quote = F)
# write.table(plasma_urine, 'results/pathway/david_plasma_urine_genes.clean.txt', sep = '\t', col.names = T, row.names = F, quote = F)
write.table(plasma_urine_coding, 'results/pathway/david_plasma_urine_genes.prot_only.clean.txt', sep = '\t', col.names = T, row.names = F, quote = F)
...
hmdb$novel = hmdb$term %in% hmdb_new$term
hmdb$novel = ifelse(hmdb$novel, 'Novel', '')
