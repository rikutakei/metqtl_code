# Pull out lead variant +/-500kb from the plasma metQTL summary stats from
# Schlosser
#
# Rscript src/query/pull_plasma_metqtl.R data/schlosser_metqtl/GCST90266422_buildGRCh37.tsv.gz
library(vroom)
library(dplyr)
library(tidyr)
library(purrr)
...
out_name = gsub('COM', compound, 'results/metqtl/schlosser/plasma/COM/SNP.metqtl.txt')
