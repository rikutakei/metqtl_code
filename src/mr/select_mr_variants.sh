...
parallel "cat <(head -1 {}) <(grep -Fwf /scratch/rtakei/projects/2023/metqtl_project/data/mr_dat/all_mr_snps.txt {}) > {.}.mr.txt " ::: $(ls /scratch/rtakei/projects/2023/metqtl_project/data/mr_dat/*sumstats.txt)
